    ...
    public class MasterDataAccess
    {
        ...
        public List<MasterModel> GetMasterData(out bool status) 
        {
            ...
            try
            {
                ...
                string Query = "select pay.spgetmaster('ref1');FETCH ALL IN \"ref1\";";
        ...
        public bool DeleteMasterData(MasterModel data, out bool status)
        {
            ...
            {
                DataSet dt = new DataSet();
                string Query = @$"select pay.spdeletemaster('{data.ID}');";
        ...
        public List<MasterModel> FilterMasterData(DateModel data, out bool status)
        {
            ...
            try
            {
                ...
                DataSet dt = new DataSet();
                string Query = @$"select pay.spgetdatabymonthmaster('{data.Current}','{data.Previous}','ref1');FETCH ALL IN ""ref1"";";
        ...
        public List<MasterModel> FilterMasterByDate(DateModel data, out bool status)
        {
            ...
            try
            {
                ...
                DataSet dt = new DataSet();
                string Query = @$"select pay.spgetbydatemaster('{current}','ref1');FETCH ALL IN ""ref1"";";
        ...
        public List<MasterModel> GetUniqueDates( out bool status)
        {
            ...
            {
                DataSet dt = new DataSet();
                string Query = @$"select pay.spgetuniquedates('ref1');FETCH ALL IN ""ref1"";";
